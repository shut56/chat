  ...
  return (
    <div id="message-history" className="px-6 py-4 overflow-y-auto h-full">
      ...
      <div className="flex items-start mb-4">
        <img src="https://i.imgur.com/8Km9tLL.jpg" className="w-10 h-10 rounded-full mr-3" alt="user avatar" />
        <div className="flex flex-col">
          ...
          <div id="code-tag" className="text-gray-300 bg-gray-700 border border-gray-800 font-mono rounded p-3 mt-2">
